...
public class GUI {
    public void UI() {
        ...
        Gvar.gbc.gridwidth = 1;
        item = nyelvinput.ReadLine(Gvar.nyelv, 22);
        Gvar.WEBTEST = new JButton(item);

        Gvar.panel.add(Gvar.WEBTEST, Gvar.gbc);
        // filemanager
        Gvar.gbc.gridx = 9;
        item = nyelvinput.ReadLine(Gvar.nyelv, 23);
        Gvar.Filemanager = new JButton(item);
        Gvar.panel.add(Gvar.Filemanager, Gvar.gbc);
